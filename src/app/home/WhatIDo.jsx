export const WhatIDo = () => {
  return (
    <section className="dark:text-gray-200 text-gray-600 body-font dark:bg-gradient-to-r dark:from-gray-900/75 dark:to-slate-900/75 dark:bg-gradient-to-b dark:from-slate-900/75 dark:to-cyan-900 bg-gradient-to-r from-fuchsia-100 to-cyan-100/75 bg-gradient-to-b from-fuchsia-100 to-cyan-100">
